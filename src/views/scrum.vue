<template>
  <div>
    <Presentation
      :title="$t('whatIsItScrum')"
      :presentationText="$t('presentantion')"
      :urlImage="require('../assets/agile-method.gif')"
    />
    <div class="title-actors px-80">
      {{ $t('titleScrumActors') }}
    </div>
    ...
    <MediumSection typeSearch="Scrum" :subTitle="$t('titleTopics', {complement: 'scrum'})" />
  </div>
</template>
